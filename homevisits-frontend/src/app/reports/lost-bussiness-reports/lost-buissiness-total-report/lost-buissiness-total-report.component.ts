...
@Component({
  selector: 'app-lost-buissiness-total-report',
  templateUrl: './lost-buissiness-total-report.component.html',
  styleUrls: ['./lost-buissiness-total-report.component.css']
})
export class LostBuissinessTotalReportComponent extends BaseComponent implements OnInit {
