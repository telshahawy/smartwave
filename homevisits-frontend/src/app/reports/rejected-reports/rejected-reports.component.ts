...
@Component({
  ...
  styleUrls: ['./rejected-reports.component.css']
})
export class RejectedReportsComponent extends FormManage implements OnInit {
  ...
  constructor(private fb: FormBuilder, private route: ActivatedRoute
    , public router: Router, private service: ClientService,
  ...
  createVisitReports(visit) {
    this.service.reportsService.getVisitReject(visit).subscribe(res => {
      ...
      this.router.navigate(['/client/reports/rejected-reports/details']);
