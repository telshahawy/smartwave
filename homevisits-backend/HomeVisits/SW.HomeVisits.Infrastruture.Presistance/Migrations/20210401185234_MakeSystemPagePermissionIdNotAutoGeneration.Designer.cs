...
namespace SW.HomeVisits.Infrastruture.Presistance.Migrations
{
    ...
    [Migration("20210401185234_MakeSystemPagePermissionIdNotAutoGeneration")]
    partial class MakeSystemPagePermissionIdNotAutoGeneration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SW.HomeVisits.Domain.Entities.ChemistVisitOrder", b =>
                {
                    b.Property<Guid>("ChemistVisitOrderId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("DurationInTraffic")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ChemistVisitOrder","HomeVisits");
                });
            ...
            modelBuilder.Entity("SW.HomeVisits.Domain.Entities.RolePermission", b =>
                {
                    ...
                    b.Property<int>("SystemPagePermissionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SystemPagePermissionId");
            ...
            modelBuilder.Entity("SW.HomeVisits.Domain.Entities.SystemPage", b =>
                {
                    ...
                    b.Property<bool>("IsDisplayInMenue")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SW.HomeVisits.Domain.Entities.SystemPagePermission", b =>
                {
                    b.Property<int>("SystemPagePermissionId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("SystemPagePermissionId");

                    b.HasIndex("PermissionId");

                    b.HasIndex("SystemPageId");

                    b.ToTable("SystemPagePermissions","HomeVisits");
                });
            ...
            modelBuilder.Entity("SW.HomeVisits.Domain.Entities.UserAdditionalPermission", b =>
                {
                    b.Property<Guid>("UserAdditionalPermissionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("UserAdditionalPermissionId");

                    b.HasIndex("SystemPagePermissionId");

                    b.HasIndex("UserId");

                    b.ToTable("UserAdditionalPermissions","HomeVisits");
                });
            ...
            modelBuilder.Entity("SW.HomeVisits.Domain.Entities.UserExcludedRolePermission", b =>
                {
                    b.Property<Guid>("UserExcludedRolePermissionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("UserExcludedRolePermissionId");
                    ...
                    b.ToTable("UserExcludedRolePermissions","HomeVisits");
                });
            ...
            modelBuilder.Entity("SW.HomeVisits.Domain.Entities.Visit", b =>
                {
                    ...
                    b.Property<DateTime?>("RelativeDateOfBirth")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("SW.HomeVisits.Domain.Entities.RolePermission", b =>
                {
                    ...
                    b.HasOne("SW.HomeVisits.Domain.Entities.SystemPagePermission", "SystemPagePermission")
                        .WithMany()
                        .HasForeignKey("SystemPagePermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SW.HomeVisits.Domain.Entities.SystemPagePermission", b =>
                {
                    ...
                    b.HasOne("SW.HomeVisits.Domain.Entities.SystemPage", "SystemPage")
                        .WithMany("SystemPagePermissions")
            ...
            modelBuilder.Entity("SW.HomeVisits.Domain.Entities.UserAdditionalPermission", b =>
                {
                    ...
                    b.HasOne("SW.HomeVisits.Domain.Entities.User", null)
                        .WithMany("UserAdditionalPermissions")
            ...
            modelBuilder.Entity("SW.HomeVisits.Domain.Entities.UserExcludedRolePermission", b =>
                {
                    ...
                    b.HasOne("SW.HomeVisits.Domain.Entities.User", null)
                        .WithMany("UserExcludedRolePermissions")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
