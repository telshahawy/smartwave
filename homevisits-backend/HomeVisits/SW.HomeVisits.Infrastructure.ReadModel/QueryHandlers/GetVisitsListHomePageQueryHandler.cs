...
{
    public class GetVisitsListHomePageQueryHandler : IQueryHandler<IGetVisitHomePageQuery, ISearchVisitsQueryResponse>
    {
        private readonly HomeVisitsReadModelContext _context;
        public GetVisitsListHomePageQueryHandler(HomeVisitsReadModelContext context)
        {
            _context = context;
        }
        public ISearchVisitsQueryResponse Read(IGetVisitHomePageQuery query)
        {
            ...
            HomePageVisits = HomePageVisits.Where(
                x => x.ChemistId == null || x.VisitStatusTypeId == (int)VisitStatusTypes.Reject||x.VisitStatusTypeId==(int)VisitStatusTypes.New
                ...
                || x.VisitActionTypeId == (int)VisitActionTypes.RequestSecondVisit || x.VisitActionTypeId == (int)VisitActionTypes.AcceptAndRequestSecondVisit
                ).OrderByDescending(o => o.VisitDate);

            var totalCount = HomePageVisits.Count();
            ...
            {
                Visits = HomePageVisits.Select(v => new VisitsDto
                {
                    VisitId = v.VisitId,
                    VisitNo = v.VisitNo,
