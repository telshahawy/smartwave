...
{
    public class DeleteClientUserCommandHandler : ICommandHandler<IDeleteClientuserCommand>
    {
        ...
        public DeleteClientUserCommandHandler(IHomeVisitsUnitOfWork unitOfWork, ILog log, UserManager<User> userManager)
        {
            _unitOfWork = unitOfWork;
            _log = log;
            _userManager = userManager;
        }
        public void Handle(IDeleteClientuserCommand command)
        {
            try
            {
