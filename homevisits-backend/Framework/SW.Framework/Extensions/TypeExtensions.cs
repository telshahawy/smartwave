...
namespace SW.Framework.Extensions
{
    ...
    public static class TypeExtensions
    {
        ...
        public static bool IsEnumerableType(this Type type)
        {
            ...
            return type.Implements(CommonTypes.SimpleIEnumerableType);
        }
        ...
        public static bool Inherits(this Type type, Type baseType)
        {
            ...
            if (type == baseType)
                return false;
            var rootType = CommonTypes.ObjectType;
            if (baseType == rootType)
                return true;
            while (type != null && type != rootType)
            {
                var current = type.IsGenericType && baseType.IsGenericTypeDefinition
        ...
        {
            return type == CommonTypes.DateTimeType || type == CommonTypes.NullableDateTimeType;
        }
