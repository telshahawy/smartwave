...
{
    /// <summary>
    ///     Defines the interface for a fluent class structure to configure request response subscriptions.
    /// </summary>
    public interface IRequestResponseSubscriptionConfiguration<TRequest, TResponse>
        ...
        where TResponse : class
    {
        ...
        /// <returns>The current instance of <see cref="IRequestResponseSubscriptionConfiguration{TRequest, TResponse}" />.</returns>
        IRequestResponseSubscriptionConfiguration<TRequest, TResponse> RetryImmediate(int retryCount);
        ...
        /// <returns>The current instance of <see cref="IRequestResponseSubscriptionConfiguration{TRequest, TResponse}" />.</returns>
        IRequestResponseSubscriptionConfiguration<TRequest, TResponse> RetryInterval(int retryCount, TimeSpan interval);
        ...
        /// <returns>The current instance of <see cref="IRequestResponseSubscriptionConfiguration{TRequest, TResponse}" />.</returns>
        IRequestResponseSubscriptionConfiguration<TRequest, TResponse> RetryIncremental(int retryLimit,
        ...
        /// <returns>The current instance of <see cref="IRequestResponseSubscriptionConfiguration{TRequest, TResponse}" />.</returns>
        IRequestResponseSubscriptionConfiguration<TRequest, TResponse> RetryExponential(int retryLimit,
            TimeSpan minInterval, TimeSpan maxInterval, TimeSpan intervalDelta);
        ...
        /// <returns>The current instance of <see cref="IRequestResponseSubscriptionConfiguration{TRequest, TResponse}" />.</returns>
        IRequestResponseSubscriptionConfiguration<TRequest, TResponse> WithCircuitBreaker(int activeThreshold,
        ...
        /// <returns>The current instance of <see cref="IRequestResponseSubscriptionConfiguration{TRequest, TResponse}" />.</returns>
        IRequestResponseSubscriptionConfiguration<TRequest, TResponse> WithRateLimit(int rateLimit, TimeSpan interval);
        ...
        /// <returns>The current instance of <see cref="IRequestResponseSubscriptionConfiguration{TRequest, TResponse}" />.</returns>
        IRequestResponseSubscriptionConfiguration<TRequest, TResponse> WithConcurrencyLimit(int concurrencyLimit);
    }
}